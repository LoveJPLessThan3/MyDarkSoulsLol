...
public class GameStateMachine
{
    ...
    public GameStateMachine(SceneLoader sceneLoader, LoadingCurtain curtain)
    {
        ...
        _states = new Dictionary<Type, IExitableState>()
        {
            ...
            [typeof(LoadLevelState)] = new LoadLevelState(this, sceneLoader, curtain, AllServices.Container.Single<IGameFactory>(), AllServices.Container.Single<IPersistentProgressService>() ),
            [typeof(LoadProgressState)] = new LoadProgressState(this, AllServices.Container.Single<IPersistentProgressService>(), AllServices.Container.Single<ISaveLoadService>()),
